这个笔记记录一些git常用和一些记不住的命令，这个笔记原本是 [王楚江的文章](https://github.com/jaywcjlove)
目录
===
<!-- TOC -->

- [配置](#配置)
- [本地拉取更新git上代码建立连接](#本地拉取更新git上代码建立连接)
...
```
git remote -v
git remote add upstream git@github.com:uiw-react/uiw.git
